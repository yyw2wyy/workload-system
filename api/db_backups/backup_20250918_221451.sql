...
(3,'填写须知','- 团建工作量放在里面写\r\n\r\n- 其他觉得算为实验室服务的工作量写在这儿\r\n\r\n- 各个小组长的工作量（审稿质量总管+小mentor、考核小组）','notice','2025-09-04 16:26:39.140015','2025-09-18 21:41:01.985038','other'),
(4,'填写须知','- 包含：标书撰写、申报书撰写、非本人负责的横向项目材料（软著、专利等）撰写、各类材料系统填报或审核、（非课程的）调研PPT\r\n\r\n- 时间节点都只能是4.30后，之前的已经统计过了。\r\n\r\n- 材料撰写完1月内申报，过期不算（系统上限制填报中的结束时间与当前时间的距离时间不可超过30天）','notice','2025-09-04 16:27:10.214838','2025-09-18 21:41:49.414617','documentation'),
(5,'填写须知','- 只能从项目列表中选择项目，如果没有请自行先申报项目，待审核完后再填写\r\n\r\n- 如果工作强度变化较大时请按分阶段写，每个阶段单独提交一次工作量，不要直接写每周多少','notice','2025-09-04 16:28:03.354311','2025-09-18 21:40:52.704168','horizontal');
...
(37,'Can add 项目',10,'add_project'),
(38,'Can change 项目',10,'change_project'),
(39,'Can delete 项目',10,'delete_project'),
(40,'Can view 项目',10,'view_project');
...
(53,'2025-09-11 16:15:29.523037','3','黄晨',2,'[{\"changed\": {\"fields\": [\"password\"]}}]',6,1),
(54,'2025-09-11 16:35:30.982981','32','fengduanyu',2,'[{\"changed\": {\"fields\": [\"Username\", \"Last login\"]}}]',6,1),
(55,'2025-09-11 16:35:38.745768','34','duweihong',2,'[{\"changed\": {\"fields\": [\"Username\"]}}]',6,1),
(56,'2025-09-11 16:35:45.198026','33','huangyoucheng',2,'[{\"changed\": {\"fields\": [\"Username\"]}}]',6,1),
(57,'2025-09-11 16:35:56.837119','3','huangchen',2,'[{\"changed\": {\"fields\": [\"Username\", \"Last login\"]}}]',6,1),
(58,'2025-09-11 16:38:18.429349','42','刘婧瑶',1,'[{\"added\": {}}]',6,1),
(59,'2025-09-11 16:38:33.889816','42','liujingyao',2,'[{\"changed\": {\"fields\": [\"Username\", \"\\u90ae\\u7bb1\", \"\\u7528\\u6237\\u89d2\\u8272\"]}}]',6,1),
(60,'2025-09-11 19:23:35.190541','43','黄幼成',3,'',6,1),
(61,'2025-09-18 21:40:52.705637','5','填写须知',2,'[{\"changed\": {\"fields\": [\"\\u5185\\u5bb9\"]}}]',8,1),
(62,'2025-09-18 21:41:01.986726','3','填写须知',2,'[{\"changed\": {\"fields\": [\"\\u5185\\u5bb9\"]}}]',8,1),
(63,'2025-09-18 21:41:49.416496','4','填写须知',2,'[{\"changed\": {\"fields\": [\"\\u5185\\u5bb9\"]}}]',8,1);
...
(30,'project','0001_initial','2025-09-10 15:34:30.343403'),
(31,'workload','0008_workload_project','2025-09-10 15:34:32.638237');
...
CREATE TABLE `project_project` (
  ...
  PRIMARY KEY (`id`),
  KEY `project_project_submitter_id_c5538abe_fk_user_user_id` (`submitter_id`),
  KEY `project_project_teacher_reviewer_id_3ffa996d_fk_user_user_id` (`teacher_reviewer_id`),
  CONSTRAINT `project_project_submitter_id_c5538abe_fk_user_user_id` FOREIGN KEY (`submitter_id`) REFERENCES `user_user` (`id`),
  CONSTRAINT `project_project_teacher_reviewer_id_3ffa996d_fk_user_user_id` FOREIGN KEY (`teacher_reviewer_id`) REFERENCES `user_user` (`id`)
...
INSERT INTO `project_project` VALUES
(1,'核动力院Agent开发','in_research','2025-06-01','approved','通过','2025-09-11 16:10:45.528280','2025-09-11 15:35:28.381455','2025-09-11 16:10:45.531656',39,35),
(2,'面壁智能——多模态大模型研发','in_research','2025-06-19','approved','通过','2025-09-11 16:10:35.451056','2025-09-11 15:44:55.145875','2025-09-11 16:10:35.453555',40,35),
(4,'test','pre_research','2025-10-08','pending',NULL,NULL,'2025-09-11 17:40:05.056464','2025-09-11 17:40:05.056488',3,NULL);
...
(1,'pbkdf2_sha256$720000$2YJlVDeMThHmzlOVwzxdjv$2VdeNucU/JHv9rpPRupfyysjjoJ4EgMWv4fWWbPTOV8=','2025-09-18 21:40:05.504264',1,'admin','','',1,1,'2025-04-06 15:40:27.400625','student','admin@example.com'),
(2,'pbkdf2_sha256$720000$Tf9D6M51AUStxBI0tyXG3m$0FH+5TcHaLzNg03n1+Q5XVoJixZx6ULxHEQhxnovCKk=','2025-09-18 21:38:34.326648',0,'王榆垚','','',0,1,'2025-04-06 19:42:54.739091','student','1@example.com'),
(3,'pbkdf2_sha256$720000$BguJNp4Jfa5qJpCzPNwyxX$lh/g6H1RFbUcrWap5tImnb+QtNux2G7GoYNXfOD4N6M=','2025-09-11 17:39:48.681211',0,'huangchen','','',0,1,'2025-04-06 19:43:00.000000','mentor','2@example.com'),
(4,'pbkdf2_sha256$720000$2oK02UyJEJ8xMJf8XRtrjQ$ZDWqNfn0wF5G22PBJhVa+ht5yqkk7leQX5MQtCcb/YQ=','2025-09-18 21:39:02.388257',0,'雷文强','','',0,1,'2025-04-06 19:44:00.000000','teacher','3@example.com'),
...
(12,'pbkdf2_sha256$720000$qIztC2Mq3P2zKhhCKI2Yte$Kpou8NC2jcaigBvxH2X/Egon+DjVkpjDtDKqllYZFcM=','2025-09-11 18:22:11.144009',0,'李阳','','',0,1,'2025-07-22 17:13:39.029701','student','im.liyang.scu@gmail.com'),
...
(22,'pbkdf2_sha256$720000$EfA4ciufhg1n3BtatR5RNH$yhI/r0SYqfNBZu4ng2evu0Q2HeFxRMw6Pwb34mT9FE8=','2025-09-18 16:10:57.693824',0,'舒雯','','',0,1,'2025-08-03 16:20:16.287489','student','1527070535@qq.com'),
(23,'pbkdf2_sha256$720000$p2KqISTzj3jh1Fcs7t4rmb$n8kJfCwuPdwrMkRrLPFxyUadi49ak2K8g2OUNccyHPM=','2025-09-18 17:16:59.853163',0,'黄柯丁','','',0,1,'2025-08-03 17:16:50.247268','student','1034151989@qq.com'),
...
(32,'pbkdf2_sha256$720000$OMlnkTi57qVSZb35uoYpvD$NVjrp2WJW90ia+/7/mrhlxwGqXT3zYYfl9VF6Vyr5qs=','2025-09-11 16:54:45.998452',0,'fengduanyu','','',0,1,'2025-08-06 15:32:00.000000','mentor','duanyu@example.com'),
(33,'pbkdf2_sha256$720000$1k4NgS8ECvFWTYVHHhPu1o$PCDPn6pWB3fGo91wBOLkn4ufSq8wsEPeEW8G/HR3jFk=','2025-09-11 17:22:05.568004',0,'huangyoucheng','','',0,1,'2025-08-06 15:33:00.000000','mentor','youcheng@example.com'),
(34,'pbkdf2_sha256$720000$WepWuLjj3vCPmGKL5ZDAEq$e1p+GTQBuyvdbzMH9E0m0UqAJXe497TPR9yYgA+bCjo=','2025-09-11 16:36:24.309287',0,'duweihong','','',0,1,'2025-08-06 15:36:00.000000','mentor','duweihong@example.com'),
(35,'pbkdf2_sha256$720000$sz8JdYcQipk5IRUCd17LWK$mLCfjmcQDB1BblQoR2AtQ+ukcvZhsSFO8RB8UeQO0iE=','2025-09-11 17:11:09.349771',0,'lianghongru','','',0,1,'2025-08-06 15:36:00.000000','teacher','lianghongru@example.com'),
...
(39,'pbkdf2_sha256$720000$Y0Pi0LkcVHTe1jwkhu6zHA$rQ3kP/8zy1iNnSGel0J8gqZQk5sbnbIATI0IHsmAaKU=','2025-09-11 15:41:07.589125',0,'riven','','',0,1,'2025-09-11 15:28:03.437654','student','1205384658@qq.com'),
(40,'pbkdf2_sha256$720000$6bVid41qnBJQtgF4TgRKBi$4IFmtHHj7c7SKagwJev2Z9CR5VMQ/8zYa5UbOkDaz5c=','2025-09-11 16:37:06.954343',0,'zhangjincheng','','',0,1,'2025-09-11 15:42:44.883287','student','erzmuxin@gmail.com'),
(41,'pbkdf2_sha256$720000$cJ3kKQ54pp6PrTlw2HOk7M$dQWt1gbBIENBcR5xACpBHuoTw97514V0pDIpS3n0vuE=','2025-09-11 16:37:49.693035',0,'tangjingkun','','',0,1,'2025-09-11 16:14:34.299919','student','1300419398@qq.com'),
(42,'pbkdf2_sha256$720000$9KCAlwmczwn0aVcdTopy4D$JJZT6tskbB9AINnAQC2T/8B154ZI+bwE25ONhsuCO/E=','2025-09-11 17:13:29.816369',0,'liujingyao','','',0,1,'2025-09-11 16:38:00.000000','mentor','liujingyao@example.com'),
(44,'pbkdf2_sha256$720000$1n8uRjOI8aM9iWYcSYLTk9$YvCUA1PHrnbRbEc2Hm4a2vvH80DH025Z12p/4R3iULY=','2025-09-11 17:54:25.264881',0,'唐锦康','','',0,1,'2025-09-11 17:43:17.350625','student','1160730419@qq.com');
...
CREATE TABLE `workload_workload` (
  ...
  KEY `workload_workload_project_id_9d8d6b48_fk_project_project_id` (`project_id`),
  ...
  CONSTRAINT `workload_workload_project_id_9d8d6b48_fk_project_project_id` FOREIGN KEY (`project_id`) REFERENCES `project_project` (`id`),
...
(13,'开发npic核动力系统前端-npic项目前端部分','为npic核动力项目系统编写前端，设计后端交互接口，设计部署方式。其中2025.1.15-2025.1.25为主要设计时间，共工作7个整天；随后2025.2.26部署一个半天','horizontal','remote','2025-01-15','2025-02-26','total',15,'pending',NULL,NULL,'2025-08-04 17:06:54.887754','2025-08-04 17:06:54.887773',29,NULL,3,NULL,NULL,'workload_files/徐纳达/None/npic.docx',NULL,NULL,NULL),
...
(15,'华二Agent开发','智能体模拟合成医患问诊数据','horizontal','onsite','2025-03-01','2025-03-19','weekly',8,'pending',NULL,NULL,'2025-08-05 09:56:03.615700','2025-08-05 09:56:03.615757',2,NULL,3,NULL,NULL,'workload_files/王榆垚/None/智能体模拟合成医患问诊数据.pdf',NULL,NULL,NULL),
(16,'华二Agent开发','代码整合、实验方案设计、系统测试优化、API开发','horizontal','remote','2025-03-20','2025-07-01','weekly',6,'pending',NULL,NULL,'2025-08-05 09:59:34.728002','2025-08-15 10:38:07.686488',2,NULL,3,NULL,NULL,'workload_files/王榆垚/None/实验方案.pdf',NULL,NULL,NULL),
(17,'华西agent','1.知识图谱、用户画像、长短期记忆的实现\r\n2.代码整合\r\n3.系统测试优化\r\n4.API开发','horizontal','remote','2025-03-01','2025-07-01','weekly',8,'pending',NULL,NULL,'2025-08-05 19:13:41.338414','2025-08-05 19:19:17.300314',14,NULL,3,NULL,NULL,'',NULL,NULL,NULL),
(18,'横向标书','网络协议分析标书撰写部分章节','horizontal','remote','2025-07-02','2025-07-15','total',14,'pending',NULL,NULL,'2025-08-06 15:52:55.546402','2025-08-06 15:57:50.041204',12,NULL,34,NULL,NULL,'',NULL,NULL,NULL),
(19,'横向线下会议','核动力院Agent项目需求线下沟通交流','horizontal','onsite','2025-07-10','2025-07-10','total',1,'pending',NULL,NULL,'2025-08-06 15:55:46.141301','2025-08-06 15:55:46.141342',12,NULL,34,NULL,NULL,'',NULL,NULL,NULL),
(26,'面壁智能——多模态大模型研发','参与minicpm-4.5v以及minicpm-4.1模型的训练，主要参与OCR的部分\r\n（以上为6.19-8.19参与的任务）','horizontal','onsite','2025-06-19','2025-08-19','daily',3,'pending',NULL,NULL,'2025-09-11 16:30:05.165760','2025-09-11 16:30:05.165781',40,NULL,3,NULL,NULL,'workload_files/zhangjincheng/None/WechatIMG1739.jpg',NULL,NULL,2),
(27,'面壁智能——多模态大模型研发','6月19-8月19日内容：参与训练MiniCPM-V，（1）对SFT后的MiniCPM-V进行视频理解的后训练，引入压缩模块resampler对视频token进行压缩，提高处理效率，（2）编写支持分布式训练、序列并行以及训练中的各种infra优化代码，（3）编写引入动态打包method改进resampler代码，和原版resampler的MiniCPM-V进行横向对比，验证了打包的无效。（4）编写支持对封包模型和竞品模型做视频理解能力和效率测试验证代码，验证模型的优越性。','horizontal','onsite','2025-06-17','2025-08-17','daily',3,'pending',NULL,NULL,'2025-09-11 16:39:03.549235','2025-09-11 16:39:03.549254',41,NULL,3,NULL,NULL,'workload_files/tangjingkun/None/证明.docx',NULL,NULL,2),
(28,'提交测试','提交测试是否有Bug','other','remote','2025-09-10','2025-09-11','total',1,'pending',NULL,NULL,'2025-09-11 17:53:14.234701','2025-09-11 17:53:14.234734',44,NULL,42,NULL,NULL,'workload_files/唐锦康/None/Snipaste_2025-09-11_17-50-46.png',NULL,NULL,NULL);
...
-- Dump completed on 2025-09-18 22:14:51
