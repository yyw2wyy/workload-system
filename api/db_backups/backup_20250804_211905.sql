...
(1,'工作量系统测试','麻烦各位25级的同学参与一下工作量系统的测试\r\n报告系统bug：http://106.55.103.208:8090/x/KYAc\r\n提出优化建议：http://106.55.103.208:8090/x/MoAc','notice','2025-04-06 16:02:33.100314','2025-08-04 19:37:50.102451'),
(2,'横向工作量申报说明','工作量申报规则和之前线下一致。同一个项目如果涉及到实地（如驻场），时间段要与远程区分开了，分两次填写。\r\n\r\n工作量类型：\r\n远程（在401、406、黄大年、家里）、实地（如驻场）\r\n\r\n工作强度：\r\n1强度值=1硬件小组工作量=半天\r\n根据工作强度类型、工作强度值以及起止时间来核算最终的工作量\r\n无特殊说明按照每周5天也即是每周最多10个工作强度值计算\r\n\r\n证明材料：\r\n可选，支持图片、PDF、word、excel。$\\color{red}只能上传一个文件$，推荐图片或PDF，不需要下载即可在浏览器中预览。','notice','2025-08-04 19:47:53.479123','2025-08-04 19:47:53.479158');
...
(1,'pbkdf2_sha256$720000$2YJlVDeMThHmzlOVwzxdjv$2VdeNucU/JHv9rpPRupfyysjjoJ4EgMWv4fWWbPTOV8=','2025-08-04 20:02:34.988902',1,'admin','','',1,1,'2025-04-06 15:40:27.400625','student','admin@example.com'),
(2,'pbkdf2_sha256$720000$Tf9D6M51AUStxBI0tyXG3m$0FH+5TcHaLzNg03n1+Q5XVoJixZx6ULxHEQhxnovCKk=','2025-08-04 19:48:11.552609',0,'王榆垚','','',0,1,'2025-04-06 19:42:54.739091','student','1@example.com'),
(3,'pbkdf2_sha256$720000$mbMGwmphKriuycX59kalCK$uJzxw2ioSHRDwbmrAlwxZ4Ll6Opw5KPBefLdbMnZAUI=','2025-07-15 16:07:30.198057',0,'晨哥','','',0,1,'2025-04-06 19:43:00.000000','mentor','2@example.com'),
(4,'pbkdf2_sha256$720000$2oK02UyJEJ8xMJf8XRtrjQ$ZDWqNfn0wF5G22PBJhVa+ht5yqkk7leQX5MQtCcb/YQ=','2025-08-04 19:57:41.835960',0,'雷文强','','',0,1,'2025-04-06 19:44:00.000000','teacher','3@example.com'),
...
(12,'pbkdf2_sha256$720000$qIztC2Mq3P2zKhhCKI2Yte$Kpou8NC2jcaigBvxH2X/Egon+DjVkpjDtDKqllYZFcM=','2025-07-22 17:18:15.437156',0,'李阳','','',0,1,'2025-07-22 17:13:39.029701','student','im.liyang.scu@gmail.com'),
...
(14,'pbkdf2_sha256$720000$0zJuQ1Nyl4cROmAyT8f4op$tPtnBWTB55ktXnowKs+EeZQfyLqI9a1o8IxgtuhyZiA=','2025-08-03 15:54:56.246194',0,'柯继翔','','',0,1,'2025-07-22 18:24:14.291278','student','1263794675@qq.com'),
...
(23,'pbkdf2_sha256$720000$p2KqISTzj3jh1Fcs7t4rmb$n8kJfCwuPdwrMkRrLPFxyUadi49ak2K8g2OUNccyHPM=','2025-08-04 20:00:40.198549',0,'黄柯丁','','',0,1,'2025-08-03 17:16:50.247268','student','1034151989@qq.com'),
...
(13,'开发npic核动力系统前端-npic项目前端部分','为npic核动力项目系统编写前端，设计后端交互接口，设计部署方式。其中2025.1.15-2025.1.25为主要设计时间，共工作7个整天；随后2025.2.26部署一个半天','horizontal','remote','2025-01-15','2025-02-26','total',15,'pending',NULL,NULL,'2025-08-04 17:06:54.887754','2025-08-04 17:06:54.887773',29,NULL,3,NULL,NULL,'workload_files/徐纳达/None/npic.docx'),
...
-- Dump completed on 2025-08-04 21:19:05
