...
import {
  projectStatusMap, reviewStatusMap
...
type Project = {
  ...
  name: string,
  start_date: string,
  project_status: keyof typeof projectStatusMap,
  review_status: keyof typeof reviewStatusMap
}
...
export default function ProjectsubmittedPage() {
  ...
  // 判断项目是否可编辑（未审核或审核未通过）
  const isEditable = (review_status: string) => {
    return review_status === "pending" || review_status=== "rejected"
  }

  // 筛选项目列表
  const filteredProjects = Projects.filter((project) => {
    const matchesProjectStatus = selectedProjectStatus === "all" || project.project_status === selectedProjectStatus
    const matchesReviewStatus = selectedReviewStatus === "all" || project.review_status === selectedReviewStatus
    return matchesProjectStatus && matchesReviewStatus
  })
        ...
        <Card className="p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div className="space-y-1">
              <h3 className="text-2xl font-semibold tracking-tight">已提交项目</h3>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
              ...
              <Select value={selectedReviewStatus} onValueChange={(value) => {
                ...
                <SelectContent>
                  ...
                  <SelectItem value="approved">教师已审核</SelectItem>
                  <SelectItem value="rejected">教师已驳回</SelectItem>
                </SelectContent>
              </Select>

              <Select value={selectedProjectStatus} onValueChange={(value) => {
          ...
          <div className="rounded-lg border shadow-sm">
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  <TableRow>
                    <TableCell colSpan={isTeacher ? 11 : 10} className="h-32 text-center">
                  ...
                  currentProjects.map((project) => (
                    <TableRow key={project.id} className="hover:bg-gray-50">
                      ...
                      <TableCell>{format(new Date(project.start_date), "yyyy年MM月dd日")}</TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-right space-x-1">
                        ...
                        {isEditable(project.review_status) && (
                          <>
                            <Button
                              variant="ghost"
                              size="icon"
